...
<div class="container" style="border: solid #636b6f 1px; border-radius: 10px; padding: 20px; max-width: 1040px; margin: auto" align="center">
    ...
    <div class="row" style="margin-top: 20px; margin-bottom: 20px; border-bottom: solid #a3b1be 1px;">
        <div class="col-sm-12" align="center">
            <h4><strong>DEALER INVOICE</strong></h4>
            <kbd>{{$invoicecode}}</kbd>
    ...
    <div class="row" style="margin-top: 10px; margin-bottom: 40px">
        ...
        <div class="col-sm-2">
            <p>Total: <strong>{{number_format($invoicerow->fullamount,2)}} LKR</strong></p>
        </div>
        <div class="col-sm-3">
...
{{--                        <td>- {{number_format($row->discount,2)}} LKR</td>--}}
                ...
                {{--<tr style="background-color: #F9F9F9">--}}
                    ...
                    {{--<td>{{number_format($invoicerow->fullamount)}} LKR</td>--}}
                {{--</tr>--}}
                {{--<tr style="background-color: #f9f9f9">--}}
                ...
                <tr style="background-color: rgba(210,218,239,0.54)">
                    ...
                    <td><h3>{{number_format($invoicerow->fullamount,2)}} LKR</h3></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-md-12" align="center">
            <a href="/pages/invoice/dealer" class="btn btn-primary" style="margin-right: 30px" id="back">back</a>
